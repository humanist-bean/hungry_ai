...
class RNN_ENCODER(nn.Module):
    ...
    def forward(self, captions, cap_lens, hidden, mask=None):
        ...
        # Alder added 2 lines below
        #print(f" The shape of 'cap_lens' is: {cap_lens}") 
        #cap_lens = cap_lens.view(17, 17, 17, 17, 17, 17)
        cap_lens = cap_lens.data.tolist()
        #NOTE: Alder added "enforce_sorted = False" to line below
